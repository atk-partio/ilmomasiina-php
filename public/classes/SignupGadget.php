...
class SignupGadget{
	...
	function insertToDatabase(){
		...
		// NOTE Atte Keinänen 13.12.2015: Joo vois. Hoidin homman.

		$escapedTitle = mysql_escape_string($this->title);
		$escapedDescription = mysql_escape_string($this->description);
		$escapedConfirmation = mysql_escape_string($this->confirmation_message);
	    ...
	    "VALUES ('$escapedTitle', '$escapedDescription', '$opens_sql', '$closes_sql', '$event_sql', '$this->password', '$send_confirmation_sql', '$escapedConfirmation')";
