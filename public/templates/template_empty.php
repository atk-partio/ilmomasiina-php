...
<?php /* Prints page content */ $this->printContent(); ?>
    ...
    <div id="contact">
      <p id="admin-email"><span>Ep�onnistumisen sattuessa ota yhteys osoitteeseen <?php /* Prints address to where user should contant in case of signup failure */ $this->printAdminEmail(); ?></span></p>
    </div>
    <div id="debug">
